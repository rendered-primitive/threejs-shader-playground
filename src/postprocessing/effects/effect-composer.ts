...
import { CopyShaderMaterial } from "../materials/copy-material";
import { ShaderPass } from "../passes/shader-pass";
import { MaskPass, ClearMaskPass } from "../passes/mask-pass";
import { Pass } from "../passes/pass";

class EffectComposer<
  TRenderTarget extends WebGLRenderTarget = WebGLRenderTarget
> {
  ...
  constructor(renderer: WebGLRenderer, renderTarget?: TRenderTarget) {
    ...
    if (CopyShaderMaterial === undefined) {
    ...
    this.copyPass = new ShaderPass(new CopyShaderMaterial());
